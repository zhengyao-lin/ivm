...
#define ivm_ctchain_getLocal(chain) (ivm_ctchain_contextStart(chain)->slots)
#define ivm_ctchain_getGlobal(chain) (ivm_ctchain_contextLast(chain)->slots)
#define ivm_ctchain_setLocal(chain, st) (ivm_ctchain_contextStart(chain)->slots = (st))
#define ivm_ctchain_setGlobal(chain, st) (ivm_ctchain_contextLast(chain)->slots = (st))
